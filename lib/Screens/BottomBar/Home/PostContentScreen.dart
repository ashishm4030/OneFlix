...
class PostContentScreen extends StatefulWidget {
  ...
  const PostContentScreen({required this.contentTPId, this.contentID, this.action, this.activityBy, this.contentType});
...
class _PostContentScreenState extends State<PostContentScreen> {
                            ...
                            child: Column(
                              ...
                              children: [
                                Stack(
                                  ...
                                  children: [
                                    CachedImage(
                                      imageUrl: 'https://image.tmdb.org/t/p/original/${content['content_cover_photo']}',
                                      width: mWidth,
                                      height: 240,
                                    ),
                                    // Positioned(
                                    ...
                                    //   left: 20,
                                    //   child: CachedImage(
                                    //     imageUrl: 'https://image.tmdb.org/t/p/original/${content['content_photo']}',
                                    //     height: 130,
                                    //     width: mWidth * 0.22,
                                    //   ),
                                    // ),
                                      ...
                                      child: Container(
                                        ...
                                        child: Column(
                                          children: [
                                            GestureDetector(
                                              onTap: () {
                                                _addToWatchList(contentThirdPartyId: content['content_third_party_id'], contentType: content['content_type']);
                                              },
                                              child: Container(
                                                alignment: Alignment.center,
                                                height: 40,
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    addedToWatchList == false ? Icon(Icons.add, size: 20, color: Colors.white) : Icon(Icons.done, size: 20, color: Colors.white),
                                                    AppText(addedToWatchList == false ? 'My List'.toUpperCase() : 'Added',
                                ...
                                content['trailer_url'] != null
                                    ? YoutubePlayerIFrame(
                                        controller: YoutubePlayerController(
                                          initialVideoId: content['trailer_url'],
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    children: [
                                          ...
                                          Expanded(
                                            child: Padding(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  AppText(content['content_title'] ?? '', fontSize: 13, color: Colors.blueGrey.shade300, fontWeight: FontWeight.w900),
                                                  GestureDetector(
                                                    // onTap: () {
                                                    //   setState(() {
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                          ...
                                                          child: Row(
                                                            children: [
                                                              CircularPercentIndicator(
                                                                radius: 44.0,
                                                                lineWidth: 2.0,
                                                                percent: double.tryParse(content['vote_average'] ?? '')! / 10,
                                                                center: AppText((double.tryParse(content['vote_average'])! * 10).toInt().toString() + "%",
                                                              ...
                                                              SizedBox(width: 6),
                                                              AppText("People like this", color: Colors.blueGrey.shade300, fontSize: 14),
                                                            ],
                                                          ),
                                                        ),
                                                        AppText(
                                                          formatDate(DateTime.parse(content['content_release_time'] ?? '')),
                                                          color: Colors.blueGrey.shade300,
                                                          fontSize: 12,
                                                        ),
                                                        // for (int i = 0; i < (genres.length < 3 ? genres.length : 3); i++) BorderedTag(tag: genres[i]['name']),
                                                        AppText("${content['content_length']} min", color: Colors.blueGrey.shade300, fontSize: 12),
                                                        // GestureDetector(
                                                        //   onTap: () {
                                                        //     showDialog(
                                                        ...
                                                        //               alignment: Alignment.center,
                                                        //               children: [
                                                        //                 content['trailer_url'] != null ? SizedBox(height: 20, width: 20, child: kProgressIndicator) : Container(),
                                                        //                 content['trailer_url'] != null
                                                        ...
                                                        //     child: AppText('WATCH TRAILER', fontSize: 9, color: Colors.white, fontWeight: FontWeight.bold),
                                                        //   ),
                                                        // )
                                                      ],
                                                    ),
                                                                            ...
                                                                            Padding(
                                                                              ...
                                                                              child: GestureDetector(
                                                                                onTap: () async {
                                                                                  ...
                                                                                  _updateSourceImpressions(contentThirdPartyId: widget.contentTPId);
                                                                                },
                                                                                child: Container(
                                      ...
                                      // clipList.length == 0 ? Container() : Divider(color: Colors.grey, height: 0, thickness: 0.2),
                                      // clipList.length == 0
                                      //     ? Container()
                                      //     : Padding(
                                        ...
                                        child: GestureDetector(
                                          onTap: () {
                                            _addToRecommended(
                                              ...
                                              contentThirdPartyId: content['content_third_party_id'],
                                              contentDescription: content['content_discription'],
                                              title: content['content_title'],
                                              posterPath: content['content_photo'],
                                              coverPhotoPath: content['content_cover_photo'],
                                              runningTime: int.tryParse(content['content_length'])!,
                                              releaseYear: content['content_release_time'],
                                              trailerUrl: content['trailer_url'] == '' || content['trailer_url'] == null || content['trailer_url'] == 'null'
                                                  ? 'null'
                                                  : content['trailer_url'],
                                              tags: content['content_tags'],
                                              watchModeId: content['content_watchmode_id'],
                                              streamingProvider: content['watch_mode_json'],
                                            );
                                          },
                                          child: Container(
                                            alignment: Alignment.center,
                                ...
                                content['count_recommended'] == 0 || (content['first_rec_user_name'] == null && content['first_null_user_name'] == null)
                                    ? Container()
                                    : Padding(
                                                  ...
                                                  children: [
                                                    ...
                                                    WidgetSpan(
                                                      child: ClipRRect(
                                                        ...
                                                        child: CachedImage(
                                                            imageUrl:
                                                                "$BASE_URL/${content['first_rec_user_name'] == null ? content['first_null_profile_pic'] : content['profile_pic']}",
                                                    ...
                                                    TextSpan(
                                                      text: content['first_rec_user_name'] == null ? ' ${content['first_null_user_name']}' : ' ${content['first_rec_user_name']}',
                                                      style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black, fontSize: 13, fontFamily: 'OpenSans'),
                                                      recognizer: TapGestureRecognizer()
                                                        ..onTap = () {
                                                          // print(content['first_rec_user_name']);

                                                          // print(content['username']);
                                                          if (content['login_user_id'] == content['activity_by']) {
                                                            Navigator.push(
                                                              context,
                                                              MaterialPageRoute(
                                                                builder: (context) => UserViewScreen(userId: content['activity_by']),
                                                              ),
                                                            );
                                                          } else {
                                                            Navigator.push(
                                                              ...
                                                              MaterialPageRoute(
                                                                builder: (context) => VisitorViewScreen(
                                                                    userID: content['first_rec_user_name'] == null ? content['first_null_activity_by'] : content['activity_by']),
                                                              ),
                                                            );
                                                          }
                                                        },
                                                    ...
                                                    TextSpan(
                                                      text: (content['count_recommended'] - 1 != 0) ? ' and' : '',
                                                      style: TextStyle(color: Colors.black, fontSize: 13, fontFamily: 'OpenSans'),
                                                    ),
                                                    TextSpan(
                                                      text: content['count_recommended'] - 1 == 1
                                                          ? ' ${content['count_recommended'] - 1} other'
                                                          : content['count_recommended'] - 1 > 1
                                                              ? ' ${content['count_recommended'] - 1} others'
                                                              : '',
                                                      style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black, fontSize: 13, fontFamily: 'OpenSans'),
                                                      recognizer: TapGestureRecognizer()
                                                        ..onTap = () {
                                                          Navigator.push(
                                                            ...
                                                            MaterialPageRoute(
                                                              builder: (context) => PostContentUserListScreen(
                                                                loginUserId: content['login_user_id'],
                                                                contentThirdPartyId: content['content_third_party_id'],
                                                                activityType: 1,
                                                                title: 'Recommended',
                                                              ),
                                ...
                                content['count_recommended'] == 0 || content['first_rec_user_name'] == null ? Container() : Divider(color: Colors.black),
                                Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: Row(
                                    children: [
                                      Row(
                                        children: [
                                          ...
                                          SizedBox(width: 5),
                                          AppText(content['normal_like'].toString(), fontWeight: FontWeight.bold, color: Colors.black, fontSize: 10),
                                        ],
                                      ),
                                      SizedBox(width: 10.0),
                                      Row(
                                        children: [
                                          ...
                                          SizedBox(width: 5),
                                          AppText(content['haha_like'].toString(), fontWeight: FontWeight.bold, color: Colors.black, fontSize: 10),
                                        ],
                                      ),
                                      SizedBox(width: 10.0),
                                      Row(
                                        children: [
                                          ...
                                          SizedBox(width: 5),
                                          AppText(content['cry_like'].toString(), fontWeight: FontWeight.bold, color: Colors.black, fontSize: 10),
                                        ],
                                      ),
                                      SizedBox(width: 10.0),
                                      Row(
                                        children: [
                                          ...
                                          SizedBox(width: 5),
                                          AppText(content['angry_like'].toString(), fontWeight: FontWeight.bold, color: Colors.black, fontSize: 10),
                                        ],
                                      ),
                                      SizedBox(width: 10.0),
                                      Row(
                                        children: [
                                          ...
                                          SizedBox(width: 5),
                                          AppText(content['love_like'].toString(), fontWeight: FontWeight.bold, color: Colors.black, fontSize: 10),
                                        ],
                                      ),
                                      SizedBox(width: 10.0),
                                      Row(
                                        children: [
                                          ...
                                          SizedBox(width: 5),
                                          AppText(content['sad_like'].toString(), fontWeight: FontWeight.bold, color: Colors.black, fontSize: 10),
                                        ],
                                      ),
                                    ],
                                  ),
                                    ...
                                    children: [
                                      FlutterFeedReaction(
                                        ...
                                        onPressed: () {
                                          ...
                                          print(content['content_third_party_id']);
                                          _addLikeOnPost(
                                            contentId: content['content_id'],
                                            contentThirdPartyId: content['content_third_party_id'],
                                            reactType: 1,
                                        ...
                                        prefix: content['is_like_me'] == 0
                                            ? Image.asset('$ICON_URL/thumb.png', width: 26.0, height: 26.0)
                                            : Image.asset('$ICON_URL/Like Icon.png', width: 24.0, height: 24.0),
                                        suffix: AppText(content['is_like_me'] == 0 ? "Like" : "Liked", color: Colors.black, fontSize: 12),
                                      ),
                                      content['comment_count'] == 0
                                          ? Container()
                                          : AppText('${content['comment_count']} ${content['comment_count'] == 1 ? "Comment" : "Comments"} ', color: Colors.black, fontSize: 13),
                                    ],
                                  ),
                                ),
                                SizedBox(height: 20),
                                                    ...
                                                    CommentFrame(
                                                      ...
                                                      onComment: () {
                                                        setState(() {
                                                          ...
                                                          commentId = friendsCommentsList[index1]['comment_id'];
                                                          contentId = friendsCommentsList[index1]['content_id'];
                                                      ...
                                                      viewReply: () {
                                                        setState(() {
                                                          if (friendsCommentsList[index1]['count_replys'] > 0) {
                                                            ...
                                                            // print(friendsCommentsList[index1]['count_replys']);
                                                            // print(friendsCommentsList[index1]['is_comments']);
                                                      ...
                                                      onTap: () {
                                                        if (content['login_user_id'] == friendsCommentsList[index1]['user_id']) {
                                                          Navigator.push(
                                                            context,
                                                            MaterialPageRoute(
                                                              ...
                                                              return CommentFrame(
                                                                ...
                                                                onEdit: () {
                                                                  setState(() {
                                                                    ...
                                                                    commentType = 1;
                                                                    commentId = friendsCommentsList[index1]['reply_data'][index2]['comment_id'];
                                                                    contentId = friendsCommentsList[index1]['reply_data'][index2]['content_id'];
                                                                    activityOnPageNo = friendsCommentsList[index1]['page_no'];
                                                                    contentThirdPartyId = friendsCommentsList[index1]['reply_data'][index2]['content_thirdparty_id'];
                                                                    editController = TextEditingController(text: friendsCommentsList[index1]['reply_data'][index2]['comment_text']);
                                                                  });
                                                                  _editFocus.requestFocus();
                                                                },
                                                                onTap: () {
                                                                  if (content['login_user_id'] == friendsCommentsList[index1]['reply_data'][index2]['user_id']) {
                                                                    Navigator.push(
                                                                      context,
                                                                      MaterialPageRoute(
                                                                        builder: (context) => UserViewScreen(userId: friendsCommentsList[index1]['reply_data'][index2]['user_id']),
                                                                      ),
                                                                    );
                                                                  } else {
                                                                    Navigator.push(
                                ...
                                otherCommentsList.length == 0 || friendsCommentsList.length == 0
                                    ? Container()
                                    : Column(
                                        children: [
                                                    ...
                                                    CommentFrame(
                                                      ...
                                                      onComment: () {
                                                        ...
                                                        setState(() {
                                                          ...
                                                          contentId = otherCommentsList[index1]['content_id'];
                                                      ...
                                                      onTap: () {
                                                        if (content['login_user_id'] == otherCommentsList[index1]['user_id']) {
                                                          Navigator.push(
                                                            context,
                                                            MaterialPageRoute(
                                                              ...
                                                              return CommentFrame(
                                                                ...
                                                                onEdit: () {
                                                                  ...
                                                                  setState(() {
                                                                    ...
                                                                    commentId = otherCommentsList[index1]['reply_data'][index2]['comment_id'];
                                                                    activityOnPageNo = otherCommentsList[index1]['page_no'];
                                                                    editController = TextEditingController(text: otherCommentsList[index1]['reply_data'][index2]['comment_text']);
                                                                    contentId = otherCommentsList[index1]['reply_data'][index2]['content_id'];
                                                                    contentThirdPartyId = otherCommentsList[index1]['reply_data'][index2]['content_thirdparty_id'];
                                                                  });
                                                                  _editFocus.requestFocus();
                                                                },
                                                                onTap: () {
                                                                  if (content['login_user_id'] == otherCommentsList[index1]['reply_data'][index2]['user_id']) {
                                                                    Navigator.push(
                                                                      context,
                                                                      MaterialPageRoute(
                                                                        builder: (context) => UserViewScreen(userId: otherCommentsList[index1]['reply_data'][index2]['user_id']),
                                                                      ),
                                                                    );
                                                                  } else {
                                                                    Navigator.push(
                                                                      context,
                                                                      MaterialPageRoute(
                                                                        builder: (context) => VisitorViewScreen(userID: otherCommentsList[index1]['reply_data'][index2]['user_id']),
                                                                      ),
                                                                    );
                                                                  }
                                                                },
                                      ...
                                      Center(
                                        child: RichText(
                                          ...
                                          text: TextSpan(
                                            children: [
                                              TextSpan(
                                                  text: 'Replying to ', style: TextStyle(color: Colors.grey, fontFamily: 'OpenSans', fontSize: 15, fontWeight: FontWeight.w900)),
                                              TextSpan(text: userName, style: TextStyle(color: Colors.black, fontFamily: 'OpenSans', fontSize: 15, fontWeight: FontWeight.w900)),
                                            ],
                                          ),
                                        ),
                                      ),
  ...
  _getContentDetails() async {
    ...
    try {
      var response = await Dio().post(
        ...
        data: {'content_id': widget.contentID, 'content_third_party_id': widget.contentTPId},
      );
      if (response.statusCode == 200) {
        ...
        if (jsonData != null) {
          setState(() {
            ...
            contentType = content['content_type'];
            watchModeJson = jsonDecode(jsonData['data']['watch_mode_json']);

            if (content['is_rec_me'] == 0) {
              recommended = false;
            } else if (content['is_rec_me'] == 1) {
              recommended = true;
            }

            if (content['added_to_watchlist'] == 0) {
              addedToWatchList = false;
            } else if (content['added_to_watchlist'] == 1) {
            ...
            if (watchModeJson.runtimeType.toString() == '_InternalLinkedHashMap<String, dynamic>') {
              print('Oops!: $watchModeJson');
              streamData = [];
            } else {
              if (watchModeJson.length == 0 || watchModeJson == [] || watchModeJson.isEmpty) {
                streamData = [];
              } else if (watchModeJson.length != 0 || watchModeJson != [] || watchModeJson.isNotEmpty || watchModeJson.length > 0) {
                temp = watchModeJson;
                ...
                for (int i = 0; i < streamData.length; i++) {
                  ...
                  typeFree.add(streamData[i]['type']);
                }
                print(typeFree);
                print('typeFree');
                ...
                streamData = resArr;
                print('streamData.length: ${streamData.length}');
              }
            }
          });
        }
  ...
  _editCommentOnPost({var index, var commentType = 0, var contentThirdPartyId, var contentId, var commentText, var commentId, var pageNo}) async {
    ...
    try {
      var response = await Dio().post(
        EDIT_COMMENT,
        options: Options(headers: {"Accept": "application/json", 'Authorization': 'Bearer $userToken'}),
        data: {'content_third_party_id': contentThirdPartyId, 'comment_text': editController.text, 'content_id': contentId, 'comment_id': commentId},
      );
      print(response);
      if (response.statusCode == 200) {
        setState(() {
  ...
  friendsCommentsListAPI({var index, var pageNo, var commentType = 0, var isActivity = false, var activityType = 0}) async {
    ...
    try {
      var response = await Dio().post(
        ...
        options: Options(headers: {"Accept": "application/json", 'Authorization': 'Bearer $userToken'}),
        data: {'page_no': pageNo, 'content_thirdparty_id': content['content_third_party_id']},
      );
      print(response);
      if (response.statusCode == 200) {
        if (!mounted) return;
        setState(() {
          ...
          if (jsonData['status'] == 1) {
            if (isActivity == false) {
              ...
              print('isActivity == false inside FRIENDS_COMMENTS_LIST');
              ...
              print('isActivity == true/ELSE inside FRIENDS_COMMENTS_LIST');
              if (activityType == 0) {
        ...
        print('FRIENDS COMMENTS: ${friendsCommentsList.length}');
      } else {
        Toasty.showtoast('Something Went Wrong');
      }
    } on DioError catch (e) {
  ...
  otherCommentListAPI({var index, var pageNo, var isActivity = false, var activityType = 0}) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // print('OTHER COMMENTS RESPONSE: ${otherCommentsList.length}');
      } else {
        Toasty.showtoast('Something Went Wrong');
      }
    } on DioError catch (e) {
  ...
  addToViewed() async {
    ...
    try {
      var response = await Dio().post(
        ...
        options: Options(headers: {"Accept": "application/json", 'Authorization': 'Bearer $userToken'}),
        data: {
          'content_third_party_id': content['content_third_party_id'],
          'content_type': content['content_type'],
          'content_discription': content['content_discription'],
          'content_photo': content['content_photo'],
          'content_title': content['content_title'],
          'content_cover_photo': content['content_cover_photo'],
          'content_trailer_time': '00:00',
          'content_release_time': content['content_release_time'],
          'content_tags': content['content_tags'],
          'content_length': int.tryParse(content['content_length'])!,
          'trailer_url': content['trailer_url'] == '' || content['trailer_url'] == null || content['trailer_url'] == 'null' ? 'null' : content['trailer_url'],
          'vote_average': content['vote_average'],
          'content_watchmode_id': content['content_watchmode_id'],
          'watch_mode_json': content['watch_mode_json'],
          'source_id': sourceID.join(','),
          'free_source_id': sourceID.join(','),
          'free_type_name': typeFree.join(','),
          'content_category': id == 203
...
class BorderedTag extends StatelessWidget {
  final String tag;
  const BorderedTag({this.tag = ''});

  @override
  Widget build(BuildContext context) {
    return Container(
      padding: const EdgeInsets.symmetric(horizontal: 4.0, vertical: 1),
      decoration: BoxDecoration(border: Border.all(color: Colors.blueGrey.shade300), borderRadius: BorderRadius.circular(4)),
      child: AppText(tag, fontSize: 9, color: Colors.blueGrey.shade300),
    );
  }
}
